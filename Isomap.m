function [Y, R, E] = Isomap(D, n_fcn, n_size, options, outputname); 
...
if (displ==1)
     ...
     newCoord2d = [Y.coords{twod}(1,:); Y.coords{twod}(2,:)]';
	 %str_k = ['newCoord-' num2str(n_size) '.txt'];
     dlmwrite([outputname '.txt'], newCoord2d, '\t');
